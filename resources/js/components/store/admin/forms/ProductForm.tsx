...
const ProductForm = ({ product }: { product?: Product | null }) => {
  ...
  const { data, setData, processing, post, put, errors, hasErrors, clearErrors } = useForm({
    name: product?.name || '',
  ...
  const [selectedCategory, setSelectedCategory] = useState<Category | null>(product ? product.category : null);
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex-1 space-y-3">
          <div className="flex flex-col space-y-1 text-sm">
            <label htmlFor="name" className="text-[10px] tracking-widest uppercase">
              Name
            </label>
            <input
              type="text"
              ...
              required
              className="rounded border border-gray-400 px-2 py-1.5 outline-none focus:ring-1 focus:ring-sky-900"
            />
          </div>
          ...
          <div className="flex flex-col space-y-1 text-sm">
            ...
            >
              <p className="flex-1 px-2 py-1.5 text-left">
          ...
          <div className="flex flex-col space-y-1">
            <label htmlFor="description" className="text-[10px] tracking-widest uppercase">
              Description
            </label>
            <textarea
              id="description"
          ...
          <div className="flex items-center gap-x-1.5">
            ...
            />
            <label htmlFor="is_published" className="text-[10px] tracking-widest uppercase">
              Is Published
            </label>
          </div>
        </div>
