...
const InlineDatePicker = ({ value, onChange, error }: InlineDatePickerProps) => {
  ...
  const handleNumberInput = (val: string, setter: (v: string) => void, max: number) => {
  ...
  return (
    <div>
      <div className="grid grid-cols-[1fr_1fr_2fr] gap-x-0.5 rounded border border-gray-400 bg-white">
        <p className="rounded-tl bg-gray-200 text-center text-[10px] font-semibold text-gray-700 uppercase">month</p>
        <p className="border-s border-gray-400 bg-gray-200 text-center text-[10px] font-semibold text-gray-700 uppercase">
          date
        </p>
        <p className="rounded-tr border-s border-gray-400 bg-gray-200 text-center text-[10px] font-semibold text-gray-700 uppercase">
          year
        </p>
        {/* Month */}
        <input
          ...
          placeholder="MM"
          value={month}
          onChange={(e) => handleNumberInput(e.target.value, setMonth, 2)}
        ...
        <input
          ...
          placeholder="DD"
          value={day}
          onChange={(e) => handleNumberInput(e.target.value, setDay, 2)}
        ...
        <input
          ...
          placeholder="YYYY"
          value={year}
          onChange={(e) => handleNumberInput(e.target.value, setYear, 4)}
