...
const CategoryList: React.FC = () => {
  const { categories, selectedCategory, searchTerm, setSearched, resetAll, setSelectedSlug, selectedCategorySlug } =
    useFilterSearch();
  ...
  return (
    <div>
      <div className="sticky top-12 z-40 mb-2 space-y-1 bg-white py-2.5">
        <p className="text-xs font-semibold tracking-wider">Selected: </p>
