...
const Navbar: React.FC = () => {
  ...
  const isAdmin = user && user.roles && (user.roles.includes('admin') || user.roles.includes('manager'));
  ...
  // Usage:
  const handleProfileMenuClick = () => toggleMenu(showProfileMenu, setShowProfileMenu, 'profile');
  const handleMenuClick = () => toggleMenu(showHiddenMenu, setShowHiddenMenu, 'hidden');
  ...
  }, [showHiddenMenu, showProfileMenu, hiddenMenuRef.current, profileMenuRef.current]);
    ...
    <nav className="flex h-14 border-b border-gray-300 bg-gray-100">
      <div className="mx-auto flex w-full max-w-7xl items-center gap-x-6 px-4 text-gray-600">
              ...
              <>
                <li>
                  ...
                  <NavLink
                    ...
                    only={['data']}
                    preserveState
                    showIndicatorCount={user.unreadNotificationsCount > 0}
                    indicatorCount={user.unreadNotificationsCount}
                    icon="Bell"
                  />
                </li>
                <li className="relative" ref={parentProfileMenuRef}>
                  ...
                  >
                    <span className="text-sm font-semibold tracking-wider text-gray-600 uppercase">{user.fname}</span>
                    <ChevronDown
                      size={14}
        ...
        <div className="relative ml-auto md:hidden">
          ...
          {((user && user.unreadNotificationsCount > 0) || cartCount > 0) && !showHiddenMenu && (
